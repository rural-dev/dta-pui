  ...
  return (
    <SafeAreaView className='flex-1'>
        <ScrollView className='px-7 py-10' contentContainerStyle={{ flexGrow: 1 }}>
            ...
            <Text className='font-poppins-regular text-xs text-abutua pt-3'>Lupa Password? 
            <Text className='font-poppins-semi-bold text-xs text-hijau pt-3'> Reset Password </Text>
            </Text>

            <Text className='font-poppins-regular text-sm text-abutua text-center pt-10'>Belum punya Akun?</Text>
            <TouchableOpacity onPress={() => navigation.navigate('Register')}>
                <View className='bg-abuhijau h-14 mt-6 mb-16 rounded-sm items-center justify-center'>
                    <Text className='font-poppins-semi-bold text-md text-hijau'>BUAT AKUN BARU</Text>
                </View>
            </TouchableOpacity>
        </ScrollView>
    </SafeAreaView>
