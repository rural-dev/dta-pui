...
const HeaderItem = () => (
    ...
    <Image source={require('../../assets/profile.png')} style={{height:37, width: 37, marginLeft: 20}}/>
    <View className='flex h-16 border-abumuda justify-center ml-4'>
      <Text className='font-poppins-medium text-base text-hitam'>Muhammad Dzikri</Text>
      <Text className='font-poppins-regular text-xs text-hijaumuda'>ONLINE</Text>
    </View>
...
const FooterItem = () => (
  ...
  <View className='flex-1 h-16 justify-center'>
    <TextInput placeholder='Tulis Pesan' className='h-14 font-poppins-regular text-sm px-5' placeholderTextColor='#D1D1D1'></TextInput>
  </View>
  <View className='w-16 '>
    <TouchableOpacity>
...
const CardItem2 = ({ item } : { item: Item2}) => (
  ...
  <View className='py-4 items-end'>
    ...
    <Text className='font-poppins-regular text-base text-white'>{item.text}</Text>
    <Text className='font-poppins-regular text-xs text-white mt-4'>{item.time}</Text>
    </View>
    <Image source={require('../../assets/arrow-2.png')} style={{height:11, width: 22}}/>
  </View> :
  <View className='py-4'>
  <Image source={require('../../assets/arrow.png')} style={{height:11, width: 22}}/>

  <View className='bg-abumuda w-60 p-4'>
  <Text className='font-poppins-regular text-base text-hitam'>{item.text}</Text>
  <Text className='font-poppins-regular text-xs text-hitam mt-4'>{item.time}</Text>
  </View>
</View>
);
