            ...
            <ScrollView
                ...
                <View className="px-5">
                    ...
                    <TextInput
                        ...
                        className="border-abusedang border rounded h-14 font-poppins-regular text-sm px-5 mt-7"
                        placeholderTextColor="#D1D1D1"></TextInput>

                    <Text className="font-poppins-semi-bold text-lg pt-7 text-hitam mb-5">
                        Kategori
                    </Text>
                </View>
                <FlatList
